...
"""
    ...
    diff = """diff --git a/.ai/guidelines/relaticle/skills/business-review-task/references/qa-matrix.md b/.ai/guidelines/relaticle/skills/business-review-task/references/qa-matrix.md
index a..b 100644
--- a/.ai/guidelines/relaticle/skills/business-review-task/references/qa-matrix.md
+++ b/.ai/guidelines/relaticle/skills/business-review-task/references/qa-matrix.md
@@ -1,3 +1,4 @@
